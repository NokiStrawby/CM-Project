% Modified version of the original script which saves the distance from
% the approximation

datafolder = 'Core_Convergence';
...
for fi = 1:InputCount
    ...
    tic
    [U,V, it, Error, GradientNorm, ConvError] = LowRankAlgo_Rate(A, k, max_it, err_eps, grad_eps, stop_c_type, init_t, init_w, printsteps);
    elapsed = toc;
    ...
    ThisExec = table(Error, GradientNorm, ConvError);
